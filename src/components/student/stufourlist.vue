    ...
    <div class="history"   >
        <div class="centers">
            <div class="header">历年真题：
                <el-button type="warning"   @click="checked(1,1)">四级真题</el-button>
                <el-button type="warning" plain @click="checked(1,2)">六级真题</el-button>
                <el-button type="warning" plain @click="checked(1,3)">A级真题</el-button>
...
export default {
    ...
    methods: {
      ...
      //  http://ruanjian.chinadingao.com/admin/teacher/schoolpaperlst
      ...
      // const res = await this.$http.post(" http://ruanjian.chinadingao.com/admin/Examination/paperlst",qs.stringify({        
      //   id: 206,
      //   u_id: 1,
      //   identity: 2
      // }));
