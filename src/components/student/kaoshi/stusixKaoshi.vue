  ...
  <div class="sixkaoshi">
    ...
    <div class="kaoshi-box">
      <div class="button-box">
        ...
        <el-button type="warning" v-if="identity != 2 && isChakan != 1"  plain @click="isdialogVisible = true" style="background-color: #E6A23C;color:#fff;float: right;border-radius: 4px;margin-right:10px" >暂停作答</el-button>
      </div>
      <!-- 答题卡 -->
      ...
      <div class="component-box">
        ...
        <div class="big-box" v-show="isCheck == 2">
          ...
          <div v-for="(item, key, index) in duanwenlijie" class="duanwen-box">
            <el-button size="mini" type="primary" icon="el-icon-video-play" @click ="play_duanwen(item,key)"  style="margin-top: 5px; background: rgb(0, 234, 238); border: none;"  :disabled="duanwenPlay">第{{key + 1}}题</el-button>
        ...
        <div class="big-box" v-show="isCheck == 4">
          ...
          <div v-for="(item, key, index) in xinwenbaodao" class="duanwen-box">
            ...
            <div class="duanwen-options">
              <div class="option-one" v-for="(ie, k, index) in item.xuanzhe[0]">
                <el-button type="success" icon="el-icon-video-play" @click="play_xinwen_opt(ie,key,k)"  style="margin-top: 5px; background: rgb(174, 93, 161); border: none;"  ref="dw_btn">第({{k + 1}})小题听力</el-button>
                <el-popover
                  placement="left"
                  width="500"
                  trigger="hover">
        ...
        <div class="big-box" v-show="isCheck == 5">
          <div>
            ...
            <div v-for="(item, key, index) in changyuedu.xuanzhe">
              ...
              <div v-html="item.jiexi" style="padding:10px;margin-left:10px;font-size:14px;line-height:25px;" v-if="is_tijiao"></div>
            </div>
          </div>
        </div>
        <!-- 仔细阅读 -->
        ...
        <div class="big-box" v-show="isCheck == 7">
          <div
            class="zuowen-title"   style="font-size:14px;line-height:25px;"
        ...
        <div class="big-box" v-show="isCheck == 8">
          ...
          <div
            ...
            v-if="is_tijiao"
            style="border: 1px solid #ccc;padding:10px;font-size:14px;line-height:25px;"
  ...
  methods: {
    ...
    async submit() {
      ...
      const res = await this.$http.post(
        "http://ruanjian.chinadingao.com/admin/Examination/addpaper",
        qs.stringify({
          id: this.id,
