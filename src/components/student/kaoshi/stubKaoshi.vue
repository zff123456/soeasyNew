  ...
  <div class="bKaoshi">
    ...
    <div class="kaoshi-box">
      <div class="button-box">
        <el-button type="warning" plain @click.native="check(1)" :class="isCheck == 1?'checked':''">听单句</el-button>
        <el-button type="warning" plain @click.native="check(2)" :class="isCheck == 2?'checked':''">听短对话</el-button>
        <el-button type="warning" plain @click.native="check(3)" :class="isCheck == 3?'checked':''">听长对话</el-button>
        <el-button type="warning" plain @click.native="check(4)" :class="isCheck == 4?'checked':''">短文填空</el-button>
      ...
      <div class="datika">
        ...
        <div class="one-box last-box" v-if="isEdit==1">
      ...
      <div class="component-box">
        ...
        <div class="big-box" v-show="isCheck == 6">
          <div>
            <div v-for="(item, key, index) in cihuitiankong">
              <div v-html="item.wenti" style="margin-top:10px;padding:10px"></div>
              <el-input v-model="item.yn" placeholder="请输入答案" style="box-sizing: border-box;padding: 0 10px;font-size:14px;line-height:25px;"></el-input>
              <div v-if="is_tijiao" v-html="item.yiwen" style="margin-top:10px;padding:10px;font-size:14px;line-height:25px;"></div>
        ...
        <div class="big-box" v-show="isCheck == 12">
          ...
          <el-input v-model="yingyihan.yn" :autosize="{ minRows: 26}" type="textarea" style="border-radius: 0;margin: 10px 0;font-size:14px;line-height:25px;"></el-input>
          <div v-html="yingyihan.cankaodaan" v-if="is_tijiao" style="border: 1px solid #ccc;padding:10px;font-size:14px;line-height:25px;">{{yingyihan.cankaodaan}}</div>
          <div v-html="yingyihan.jiexi" v-if="is_tijiao" style="margin-top:10px;border: 1px solid #ccc;padding:10px;font-size:14px;line-height:25px;">{{yingyihan.jiexi}}</div>
        </div>
        <!-- 作文题 -->
