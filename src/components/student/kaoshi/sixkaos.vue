<template>
    <div class="sixkaoshi">
      ...
      <div class="title-box">
        ...
        <p ><el-button type="text" v-text="keepTime"   class="keepTime"></el-button></p>   
    ...
    methods: {
      ...
      async gettItem() {
        ...
        const res = await this.$http.post(
          ...
          // id: this.kaoshiId,u_id:this.id,identity: this.identity
          qs.stringify({id:163,u_id:1,identity:2})
        );
