      ...
      <div class="datika">
        ...
        <div class="one-box">
          ...
          <div class="span-box" v-for="(item, key, index) in tingduanduihua">
            ...
            <span :class="ie.yn == ''? '': 'chec'" v-for="(ie, k) in item.xuanzhe[0]"  @click ="check(1)">{{k + 1}}</span>
        ...
        <div class="one-box">
          ...
          <div class="span-box" v-for="(item, key, index) in tingchangduihua">
            <em style="font-style:normal;margin-right:5px;font-size:16px">第{{ key + 1 }}大题</em>
            <span :class="ie.yn == ''? '': 'chec'" v-for="(ie, k) in item.xuanzhe[0]"  @click ="check(2)">{{k + 1}}</span>
        ...
        <div class="one-box">
          ...
          <div class="span-box">
            <span :class="duanwentiankong.yn[key] == ''? '': 'chec'" v-for="(item, key, index) in duanwentiankong.yn"  @click ="check(3)">{{key + 1}}</span>
        ...
        <div class="one-box">
          ...
          <div class="span-box" v-for="(item, key, index) in tingduanwen">
            <em style="font-style:normal;margin-right:5px;font-size:16px">第{{ key + 1 }}大题</em>
            <span :class="ie.yn == ''? '': 'chec'" v-for="(ie, k) in item.xuanzhe"  @click ="check(4)">{{k + 1}}</span>
        ...
        <div class="one-box">
          ...
          <div class="span-box">
            <span :class="item.yn == ''? '': 'chec'" v-for="(item, key, index) in cihuixuanzhe"  @click ="check(5)">{{key + 1}}</span>
        ...
        <div class="one-box">
          ...
          <div class="span-box">
            <span :class="item.yn == ''? '': 'chec'" v-for="(item, key, index) in cihuitiankong"  @click ="check(6)">{{key + 1}}</span>
        ...
        <div class="one-box">
          ...
          <div class="span-box" v-for="(item, key, index) in zixiyuedu">
            <em style="font-style:normal;margin-right:5px;font-size:16px">第{{ key + 1 }}大题</em>
            <span :class="ie.yn == ''? '': 'chec'" v-for="(ie, k) in item.xuanzhe[0]"  @click ="check(7)">{{k + 1}}</span>
        ...
        <div class="one-box">
          ...
          <div class="span-box">
            <span :class="yuedutiankong.yn[key] == ''? '': 'chec'" v-for="(item, key, index) in yuedutiankong.yn"  @click ="check(8)">{{key + 1}}</span>
        ...
        <div class="one-box">
          ...
          <div class="span-box" v-for="(item, key, index) in cihuipipei">
            ...
            <span :class="ie.yn == ''? '': 'chec'" v-for="(ie, k) in item.xuanzhe"   @click ="check(9)">{{k + 1}}</span>
        ...
        <div class="one-box">
          ...
          <div class="span-box" v-for="(item, key, index) in yuedulijie">
            <em style="font-style:normal;margin-right:5px;font-size:14px">第{{ key + 1 }}大题</em>
            <span :class="ie.yn == ''? '': 'chec'" v-for="(ie, k) in item.xuanzhe"  @click ="check(10)">{{k + 1}}</span>
        ...
        <div class="one-box">
          ...
          <div class="span-box">
            <span :class="item.yn == ''? '': 'chec'" v-for="(item, key, index) in fanyixuanzhe"  @click ="check(11)">{{key + 1}}</span>
        ...
        <div class="one-box">
          ...
          <div class="span-box">
            <span :class="yingyihan.yn == ''? '': 'chec'"  @click ="check(12)">1</span>
        ...
        <div class="one-box">
          ...
          <div class="span-box">
            <span :class="zuowen.yn == ''? '': 'chec'" @click ="check(13)">1</span>
      ...
      <div class="component-box">
        ...
        <div class="big-box fs16" v-show="isCheck == 4">
          ...
          <div v-for="(item, key, index) in tingduanwen" class="duanwen-box">
            ...
            <div v-if="is_tijiao" v-html="item.yiwen" style="margin-top:10px;border: 1px solid #ccc;padding:10px;font-size:14px;line-height:25px;" class="fs16">{{item.yiwen}}</div>
          ...
          <div v-for="(item, key, index) in tingduanduihua" class="duanwen-box">
            <div class="duanwen-options" >
              <div class="option-one" v-for="(ie, k, index) in item.xuanzhe[0]">
                <el-button type="success" icon="el-icon-video-play" @click="play_duanwen_opt(ie,key,k)" ref="dw_btn" style="background: rgb(174, 93, 161);border:none;margin-top:5px;">第({{k + 1}})小题听力</el-button>
        ...
        <div class="big-box" v-show="isCheck == 3">
          ...
          <div style="overflow:hidden">
            <el-button size="mini" type="primary" icon="el-icon-video-play" @click ="play_aduanwen" :disabled="duanwenPlay" style="background: rgb(174, 93, 161);border:none;margin-top:5px;">播放音频</el-button>
            <div v-html="duanwentiankong.wenti" style="margin-top:10px;padding:10px;font-size:14px;line-height:25px;"></div>
            <div v-if="is_tijiao" v-html="duanwentiankong.yiwen" style="margin-top:10px;padding:10px;font-size:14px;line-height:25px;"></div>
            <div v-if="is_tijiao" v-html="duanwentiankong.cankaodaan" style="margin-top:10px;padding:10px;font-size:14px;line-height:25px;"></div>
            <div v-if="is_tijiao" v-html="duanwentiankong.daan" style="margin-top:10px;padding:10px;font-size:14px;line-height:25px;"></div>
        ...
        <div class="big-box" v-show="isCheck == 5">
          <div>
            <div v-for="(item, key, index) in cihuixuanzhe">
              <div v-html="item.wenti" style="margin-top:10px;padding:10px;font-size:14px;line-height:25px;"></div>
              ...
              <div v-if="is_tijiao" v-html="item.yiwen" style="margin-top:10px;padding:10px;font-size:14px;line-height:25px;"></div>
              <div v-if="is_tijiao" v-html="item.jiexi" style="margin-top:10px;padding:10px;font-size:14px;line-height:25px;"></div>
            </div>
          </div>
        </div>
        <!-- 词汇填空 -->
        <div class="big-box" v-show="isCheck == 6">
          <div>
            <div v-for="(item, key, index) in cihuitiankong">
              ...
              <div v-if="is_tijiao" v-html="item.yiwen" style="margin-top:10px;padding:10px;font-size:14px;line-height:25px;"></div>
              <div v-if="is_tijiao" v-html="item.daan" style="margin-top:10px;padding:10px;font-size:14px;line-height:25px;"></div>
              <div v-if="is_tijiao" v-html="item.cankaodaan" style="margin-top:10px;padding:10px;font-size:14px;line-height:25px;"></div>
            </div>
          </div>
        </div>
        <!-- 仔细阅读 -->
          ...
          <div v-for="(item, key, index) in zixiyuedu" class="duanwen-box">
            ...
            <div class="duanwen-options" >
              <div class="option-one" v-for="(ie, k, index) in item.xuanzhe[0]">
                ...
                <div v-html="ie.wenti" style="padding:10px;font-size:14px;line-height:25px;">{{ie.wenti}}</div>
                <div class="xuanxiang" v-for="(i,e) in ie.xuanxiang" style="margin-top: 5px">
                  <el-radio v-model="ie.yn" :label="e" :class="is_tijiao == true && ie.yn != ie.daan && e == ie.daan? 'red':''">{{i}}</el-radio>
                </div>
        ...
        <div class="big-box" v-show="isCheck == 8">
          <div style="overflow:hidden">
            <div v-html="yuedutiankong.duanwen" style="margin-top:10px;padding:10px;font-size:14px;line-height:25px;"></div>
            <div v-html="yuedutiankong.timu" style="margin-top:10px;padding:10px;font-size:14px;line-height:25px;"></div>
            <div style="overflow:hidden;">
              <div v-for="(item, key, index) in yuedutiankong.yn" style="height:52px;float:left;">
                <div style="margin: 10px 10px;width:258px">
                  <span>第{{key + 1}}题：</span>
                  <el-input v-model="yuedutiankong.yn[key]" placeholder="请输入答案" style="box-sizing: border-box;padding: 0 5px;width: 200px;font-size:14px;line-height:25px;"></el-input>
                </div>
              </div>
            </div>
            <div v-if="is_tijiao" v-html="yuedutiankong.daan" style="margin-top:10px;padding:10px;float:left;font-size:14px;line-height:25px;"></div>
            <div v-if="is_tijiao" v-html="yuedutiankong.jiexi" style="margin-top:10px;padding:10px;float:left;font-size:14px;line-height:25px;"></div>
            <div v-if="is_tijiao" v-html="yuedutiankong.cankaodaan" style="margin-top:10px;padding:10px;float:left;font-size:14px;line-height:25px;"></div>
          </div>
        </div>
        <!-- 词汇匹配 -->
        <div class="big-box" v-show="isCheck == 9">
          <div>
            <div v-for="(item, key, index) in cihuipipei">
              <div v-html="item.beixuanxiang" style="margin-top:10px;padding:10px;font-size:14px;line-height:25px;"></div>
              <div v-if="is_tijiao" v-html="item.jiexi" style="margin-top:10px;padding:10px;font-size:14px;line-height:25px;"></div>
              <div class="xuanxiang" v-for="(ie, k, index) in item.xuanzhe">
                <div v-html="ie.wenti" style="margin-top:10px;padding:10px;font-size:14px;line-height:25px;"></div>
        ...
        <div class="big-box" v-show="isCheck == 10">
          <div>
            <div v-for="(item, key, index) in yuedulijie">
              <div v-html="item.duanwen" style="margin-top:10px;padding:10px;font-size:14px;line-height:25px;"></div>
              <div v-if="is_tijiao" v-html="item.cankaodaan" style="margin-top:10px;padding:10px;font-size:14px;line-height:25px;"></div>
              <div class="xuanxiang" v-for="(ie, k, index) in item.xuanzhe">
                <el-popover
                  placement="left"
        ...
        <div class="big-box" v-show="isCheck == 11">
          <div v-for="(item, key, index) in fanyixuanzhe" class="duanwen-box">
            <div class="zuowen-title" style="font-size:14px;line-height:25px;">{{item.wenti}}</div>
            <div class="zuowen-title" v-if="is_tijiao" style="font-size:14px;line-height:25px;" >{{item.daan}}</div>
            <div class="zuowen-title" v-if="is_tijiao" style="font-size:14px;line-height:25px;">{{item.jiexi}}</div>
            <div v-if="is_tijiao" v-html="item.yiwen" style="margin-top:10px;border: 1px solid #ccc;padding:10px;font-size:14px;line-height:25px;">{{item.yiwen}}</div>
        ...
        <div class="big-box" v-show="isCheck == 12">
          <div v-html="yingyihan.wenzhang" style="padding:10px;font-size:14px;line-height:25px;">{{yingyihan.wenzhang}}</div>
          <el-input v-model="yingyihan.yn" :autosize="{ minRows: 26}" type="textarea" style="border-radius: 0;margin: 10px 0"></el-input>
          <div v-html="yingyihan.cankaodaan"  style="border: 1px solid #ccc;padding:10px;font-size:14px;line-height:25px;">{{yingyihan.cankaodaan}}</div>
          <div v-html="yingyihan.jiexi"  style="margin-top:10px;border: 1px solid #ccc;padding:10px;font-size:14px;line-height:25px;">{{yingyihan.jiexi}}</div>
        </div>
        <!-- 作文题 -->
        <div class="big-box" v-show="isCheck == 13">
          ...
          <el-input v-model="zuowen.yn" :autosize="{ minRows: 20}" type="textarea" style="border-radius: 0;margin: 10px 0"></el-input>
          <div v-html="zuowen.daan"  style="border: 1px solid #ccc;padding:10px;font-size:14px;line-height:20px;">{{zuowen.daan}}</div>
          <div v-html="zuowen.jiexi" style="margin-top:10px;border: 1px solid #ccc;padding:10px;font-size:14px;line-height:20px;">{{zuowen.jiexi}}</div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    async getItem(){
      ...
      const res = await this.$http.post("http://ruanjian.chinadingao.com/admin/Examination/paperlst",qs.stringify({id: 150,u_id:1,identity: 2}));
    ...
    goback(){
      this.$router.push('/stuOrder');//返回上一层
    },
    async suspend(){
