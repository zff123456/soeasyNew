<template>
    <div class="bKaoshi" style="margin-top:70px;">
      <div class="centers">
          <div class="title-box">
        ...
        <div class="datika">
          ...
          <div class="one-box">
            ...
            <div class="span-box" v-for="(item, key, index) in tingchangduihua">
              <em style="font-style:normal;margin-right:5px;font-size:16px">第{{ key + 1 }}大题</em>
              <span :class="ie.yn == ''? '': 'chec'" v-for="(ie, k) in item.xuanzhe[0]"  @click ="check(3)">{{k + 1}}</span>
          ...
          <div class="one-box">
            ...
            <div class="span-box">
              <span :class="duanwentiankong.yn[key] == ''? '': 'chec'" v-for="(item, key, index) in duanwentiankong.yn"   @click ="check(4)">{{key + 1}}</span>
        ...
        <div class="component-box">
          ...
          <div class="big-box" v-show="isCheck == 4">
            ...
            <div style="overflow:hidden">
              <el-button size="mini" type="primary" icon="el-icon-video-play" @click ="play_aduanwen" :disabled="duanwenPlay"  style="background:#00EAEE;border:none;margin-top:5px;">播放音频</el-button>
  ...
  export default {
    ...
    methods: {
      ...
      async getItem(){
        ...
        const res = await this.$http.post("http://ruanjian.chinadingao.com/admin/Examination/paperlst",qs.stringify({id: 149,u_id:1,identity:2}));
        console.log(res)
